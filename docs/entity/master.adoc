...
include::master03-physical_entity.adoc[leveloffset=+1]
include::master04-social_entity.adoc[leveloffset=+1]
include::master05-social_entity-party.adoc[leveloffset=+1]
include::master06-social_entity-asset.adoc[leveloffset=+1]
include::master07-resource.adoc[leveloffset=+1]
include::master08-registry.adoc[leveloffset=+1]
