...
sought by many health authorities today1, which provides an informational framework for integrated
shared care.
...
Report 183081 for which an openEHR profile has been created2. The requirements summarised above
...
image::diagrams/shared_ehr.png[id=shared_ehr, align="center", width=80%]
