...
own IEEE standard1. CM is about managed control of changes to a repository of items (formally
...
The following figure shows an abstract model of a change-controlled repository, which consists of:
