...
h|*1..1*
|*archetype_id*: `link:/releases/BASE/{rm_release}/base_types.html#_archetype_id_class[ARCHETYPE_ID^]`
a|Globally unique archetype identifier.

h|*0..1*
|*template_id*: `link:/releases/BASE/{rm_release}/base_types.html#_template_id_class[TEMPLATE_ID^]`
...
h|*1..1*
|*rm_version*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
