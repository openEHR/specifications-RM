...
h|*0..1*
|*magnitude_status*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1*
|*accuracy*: `link:/releases/BASE/{rm_release}/foundation_types.html#_any_class[Any^]`
...
h|*1..1*
|*valid_magnitude_status* (): `link:/releases/BASE/{rm_release}/foundation_types.html#_boolean_class[Boolean^]` +
 +
...
h|*1..1 +
(abstract)*
|*magnitude* (): `link:/releases/BASE/{rm_release}/foundation_types.html#_ordered_numeric_class[Ordered_Numeric^]`
a|

h|*1..1*
|*accuracy_unknown* (): `link:/releases/BASE/{rm_release}/foundation_types.html#_boolean_class[Boolean^]`
