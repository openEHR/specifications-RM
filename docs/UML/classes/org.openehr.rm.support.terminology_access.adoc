...
h|*1..1*
|*all_codes* (): `link:/releases/BASE/{base_release}/base_types.html#_code_phrase_class[CODE_PHRASE^]`
...
): `link:/releases/BASE/{base_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{base_release}/base_types.html#_code_phrase_class[CODE_PHRASE^]>`
