...
h|*1..1*
|*instruction_id*: `link:/releases/BASE/{rm_release}/base_types.html#_locatable_ref_class[LOCATABLE_REF^]`
a|Reference to causing Instruction.

h|*1..1*
|*activity_id*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
