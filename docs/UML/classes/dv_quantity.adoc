...
h|*1..1*
|*units*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1*
|*units_system*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1*
|*units_display_name*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1 +
(redefined)*
|*other_reference_ranges*: `link:/releases/BASE/{rm_release}/foundation_types.html#_list_class[List^]<@REFERENCE_RANGE<DV_QUANTITY>@>`
