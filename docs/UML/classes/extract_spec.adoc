...
h|*1..1*
|*include_multimedia*: `link:/releases/BASE/{rm_release}/foundation_types.html#_boolean_class[Boolean^]`
a|Indicates whether in-line instances of `DV_MULTIMEDIA` in the source data are included or not.

h|*1..1*
|*priority*: `link:/releases/BASE/{rm_release}/foundation_types.html#_integer_class[Integer^]`
...
h|*1..1*
|*link_depth*: `link:/releases/BASE/{rm_release}/foundation_types.html#_integer_class[Integer^]`
...
h|*0..1*
|*criteria*: `link:/releases/BASE/{rm_release}/foundation_types.html#_list_class[List^]<link:/releases/RM/{rm_release}/data_types.html#_dv_parsable_class[DV_PARSABLE^]>`
