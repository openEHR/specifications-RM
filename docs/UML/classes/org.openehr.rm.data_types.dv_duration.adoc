...
a|Numeric value of the duration as a number of seconds. Computed using the method `_to_seconds()_` inherited from `link:/releases/BASE/latest/foundation_types.html#_iso8601_duration_class[Iso8601_duration^]`.
