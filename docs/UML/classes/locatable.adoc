...
h|*1..1*
|*archetype_node_id*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1*
|*uid*: `link:/releases/BASE/{rm_release}/base_types.html#_uid_based_id_class[UID_BASED_ID^]`
a|Optional globally unique object identifier for root points of archetyped structures.

h|*0..1*
|*links*: `link:/releases/BASE/{rm_release}/foundation_types.html#_list_class[List^]<<<_link_class,LINK>>>`
...
h|*1..1*
|*is_archetype_root* (): `link:/releases/BASE/{rm_release}/foundation_types.html#_boolean_class[Boolean^]`
