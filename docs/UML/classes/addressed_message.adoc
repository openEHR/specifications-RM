...
h|*1..1*
|*sender*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
a|Party sending the message.

h|*1..1*
|*sender_reference*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
...
h|*1..1*
|*addressees*: `link:/releases/BASE/{rm_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]>`
a|Intended recipients, in the form of internet addresses.

h|*0..1*
|*urgency*: `link:/releases/BASE/{rm_release}/foundation_types.html#_integer_class[Integer^]`
