...
h|*1..1*
|*openehr_code_sets* (): `link:/releases/BASE/{rm_release}/foundation_types.html#_hash_class[Hash^]<link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^], link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]>`
