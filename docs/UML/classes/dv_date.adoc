...
h|*Inherit*
2+|`<<_dv_temporal_class,DV_TEMPORAL>>`, `link:/releases/BASE/{rm_release}/foundation_types.html#_iso8601_date_class[Iso8601_date^]`
...
h|*1..1 +
(effected)*
|*magnitude* (): `link:/releases/BASE/{rm_release}/foundation_types.html#_integer_class[Integer^]`
