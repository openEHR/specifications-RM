...
h|*0..1*
|*formatting*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1*
|*mappings*: `link:/releases/BASE/{rm_release}/foundation_types.html#_list_class[List^]<<<_term_mapping_class,TERM_MAPPING>>>`
