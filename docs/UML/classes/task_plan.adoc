...
h|*0..1*
|*due_time*: `Duration`
a|Due date/time expressed as an offset, to be converted to a real date/time at instantiation.
...
a|Optional identifier for an order set, which is understood as a kind of order set, e.g. 'R-CHOP-14'.
|===
