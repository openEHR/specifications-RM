...
h|*1..1*
|*media_type*: `link:/releases/BASE/{base_release}/base_types.html#_code_phrase_class[CODE_PHRASE^]`
a|Data media type coded from openEHR code set  media types  (interface for the IANA MIME types code set).

h|*0..1*
|*compression_algorithm*: `link:/releases/BASE/{base_release}/base_types.html#_code_phrase_class[CODE_PHRASE^]`
...
h|*0..1*
|*integrity_check_algorithm*: `link:/releases/BASE/{base_release}/base_types.html#_code_phrase_class[CODE_PHRASE^]`
