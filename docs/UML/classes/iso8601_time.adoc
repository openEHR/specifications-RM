...
h|
|*as_string*: `String`
a|ISO8601 string for time, i.e. in form: hhmmss[(,&#124;.)s[s[s[s[s[s]]]]]][Z&#124;±hh[mm]] or the extended form: hh:mm:ss[(,&#124;.)s[s[s[s[s[s]]]]]][Z&#124;±hh[mm]], or a partial invariant. See valid_iso8601_time for validity.

h|
|*valid_iso8601_time*: `Boolean`
a|String is a valid ISO 8601 date, i.e. takes the form:

* hhmmss[(,&#124;.)s[s[s[s[s[s]]]]]][Z&#124;±hh[mm]]

or the extended form:

* hh:mm:ss[(,&#124;.)s[s[s[s[s[s]]]]]][Z&#124;±hh[mm]]
...
* [(,&#124;.)s[s[s[s[s[s]]]]]] is an optional string consisting of a comma or decimal point followed by numeric string of 1-6 digits, representing a fractional second
