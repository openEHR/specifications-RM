...
h|*1..1*
|*version_count* (): `link:/releases/BASE/{rm_release}/foundation_types.html#_integer_class[Integer^]`
a|Return the total number of versions in this object.

h|*1..1*
|*all_version_ids* (): `link:/releases/BASE/{rm_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{rm_release}/base_types.html#_object_version_id_class[OBJECT_VERSION_ID^]>`
a|Return a list of ids of all versions in this object.

h|*1..1*
|*all_versions* (): `link:/releases/BASE/{rm_release}/foundation_types.html#_list_class[List^]<<<_version_class,VERSION>>>`
...
h|*1..1*
|*has_version_id* ( +
a_version_uid: `link:/releases/BASE/{rm_release}/base_types.html#_object_version_id_class[OBJECT_VERSION_ID^][1]` +
): `link:/releases/BASE/{rm_release}/foundation_types.html#_boolean_class[Boolean^]`
...
a_contribution: `link:/releases/BASE/{rm_release}/base_types.html#_object_ref_class[OBJECT_REF^][1]`, +
a_new_version_uid: `link:/releases/BASE/{rm_release}/base_types.html#_object_version_id_class[OBJECT_VERSION_ID^][1]`, +
a_preceding_version_id: `link:/releases/BASE/{rm_release}/base_types.html#_object_version_id_class[OBJECT_VERSION_ID^][1]`, +
...
a_data: `T[1]`, +
signing_key: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^][1]` +
): `void` +
 +
...
a_lifecycle_state: `link:/releases/RM/{rm_release}/data_types.html#_dv_coded_text_class[DV_CODED_TEXT^][1]`, +
a_data: `T[1]`, +
an_other_input_uids: `link:/releases/BASE/{rm_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{rm_release}/base_types.html#_object_version_id_class[OBJECT_VERSION_ID^]>[1]`, +
signing_key: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^][1]` +
): `void` +
 +
__Pre__: `all_version_ids.has (a_preceding_version_uid) or else version_count = 0`
...
a_ver_id: `link:/releases/BASE/{rm_release}/base_types.html#_object_version_id_class[OBJECT_VERSION_ID^][1]`, +
signing_key: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^][1]` +
): `void` +
 +
__Pre__: `has_version_id(a_ver_id)
