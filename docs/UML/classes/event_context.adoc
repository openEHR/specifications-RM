...
h|*0..1*
|*location*: `link:/releases/BASE/{rm_release}/foundation_types.html#_string_class[String^]`
...
h|*0..1*
|*participations*: `link:/releases/BASE/{rm_release}/foundation_types.html#_list_class[List^]<link:/releases/RM/{rm_release}/common.html#_participation_class[PARTICIPATION^]>`
