...
|UML file for MagicDraw 18.2 for RM model. Contains UML 2.5 standard XMI file.

|link:/releases/BASE/{base_release}/UML/openEHR_UML-Base.mdzip[openEHR_UML-Base.mdzip]
|UML file for MagicDraw 18.2 for BASE model (included by RM). Contains UML 2.5 standard XMI file.
