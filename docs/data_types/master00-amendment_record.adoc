...
|[[latest_issue]]
|{spec_tickets}/SPECAM-82[SPECAM-82^]: Remove the `CODE_PHRASE` class definition from Data Types; it is now defined in the openEHR Base Types specification (`base_types.terminology` package) since BASE Release 1.3.0, and the Reference Model reuses that definition.
|S Iancu
