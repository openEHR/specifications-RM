...
* the code phrase provided by the terminology service, recorded in the `_defining_code_` attribute.
...
has no known allergies to penicillin or another class of medication that is being prescribed. The often proposed
