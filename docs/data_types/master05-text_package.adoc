...
NOTE: Since BASE Release 1.3.0, the `CODE_PHRASE` class is defined in the openEHR {openehr_base_types}[Base Types specification^] (`base_types.terminology` package) rather than in this specification; the Reference Model reuses that definition.
