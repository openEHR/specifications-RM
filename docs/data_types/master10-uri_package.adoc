...
The syntax is described in more detail in the section on Paths in The openEHR Architecture Overview
document <<openehr_overview#+_ehr_uris+>>. `DV_EHR_URIs` are used as a mechanism for referencing in the EHR, ensuring readability
