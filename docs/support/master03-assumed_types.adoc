...
|`Hash<V,K: Comparable>` |a table of values of any type V, keyed by instances of any basic comparable type K, typically String or Integer, but may be more complex types, e.g. a coded term type. | Table
