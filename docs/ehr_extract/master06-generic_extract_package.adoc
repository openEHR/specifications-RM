...
image::{uml_export_dir}/diagrams/RM-ehr_extract.generic_extract.svg[id=rm_generic_extract, align="center"]
...
image::diagrams/typical_generic_extract.png[id=typical_generic_extract, align="center", width=80%]
