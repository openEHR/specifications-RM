...
image::{diagrams_uri}/history_period.png[id=history_period, align="center", width=70%]
...
image::{diagrams_uri}/history_bp.png[id=history_bp, align="center", width=70%]
...
image::{diagrams_uri}/history_bp_math.png[id=history_bp_math, align="center", width=60%]
...
image::{diagrams_uri}/history_data_compression.png[id=history_data_compression, align="center", width=70%]
...
[.text-center]
.State in `HISTORY`
image::{diagrams_uri}/history_ogtt.png[id=history_ogtt, align="center", width=65%]
...
image::{diagrams_uri}/history_single_sample.png[id=history_single_sample, align="center", width=70%]
...
image::{diagrams_uri}/history_bp_series_instances.png[id=history_bp_series_instances, align="center", width=70%]
