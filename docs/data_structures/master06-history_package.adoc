...
image::{diagrams_uri}/history_single_sample.svg[id=history_single_sample, align="center", width=60%]
...
image::{diagrams_uri}/history_bp_series_instances.svg[id=history_bp_series_instances, align="center", width=70%]
