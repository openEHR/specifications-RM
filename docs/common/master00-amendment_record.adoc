...
|[[latest_issue]]2.1.6
|{spec_tickets}/SPECPR-392[SPECPR-392^]: Correct the `OBJECT_VERSION_ID` example in the version identification scheme to use double colons (`"1234::system_id::version_tree_id"`), and align the description of `_creating_system_id_` forms (reverse domain name, GUID or ISO OID) with the BASE Architecture Overview.
|J Zeilstra, +
S Iancu
