...
|J Mewes
|[[latest_issue_date]]09 Nov 2019

|
|{spec_tickets}/SPECRM-74[SPECRM-74^]. Add other_details meta-data field to `FEEDER_AUDIT_DETAILS` (addresses {spec_tickets}/SPECPR-271[SPECPR-271^]).
|B Haarbrandt
|10 Oct 2019
