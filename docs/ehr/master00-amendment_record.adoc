...
|{openehr_jira}/SPECRM-71[SPECRM-71]. Make `ACTIVITY._timing_` optional. +
 {openehr_jira}/SPECRM-68[SPECRM-68]. Improve guidance on use of `ACTIVITY._timing_` (Fixes {openehr_jira}/SPECPR-242[SPECPR-242]. +
 {openehr_jira}/SPECRM-69[SPECRM-69]. Add missing ISM transitions and improve documentation of states (Fixes {openehr_jira}/SPECPR-203[SPECPR-203].
|P Pazos
