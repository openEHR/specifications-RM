...
|{openehr_jira}/SPECRM-76[SPECRM-76]: Add `VERSIONED_PARTY` class definition to demographics specs. +
 ...
 {openehr_jira}/SPECRM-82[SPECRM-82]: Fix incorrect redefinition of `PARTY._uid_` in UML (from RM 1.0.2 UML conversion?); revert to inherited attribute (Fixes {openehr_jira}/SPECPR-282[SPECPR-282]).
|S Iancu
