...
include::ROOT:partial$classes/item_structure.adoc[]

include::ROOT:partial$classes/item_single.adoc[]

include::ROOT:partial$classes/item_list.adoc[]

include::ROOT:partial$classes/item_table.adoc[]

include::ROOT:partial$classes/item_tree.adoc[]
...
image::diagrams/instance_item_single.svg[id=instance_item_single, align="center", width=50%]
...
image::diagrams/instance_item_list.svg[id=instance_item_list, align="center", width=75%]
...
image::diagrams/instance_item_table.svg[id=instance_item_table, align="center"]
...
image::diagrams/instance_item_tree.svg[id=instance_item_tree, align="center"]
