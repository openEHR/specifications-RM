...
image::diagrams/history_bp.svg[id=history_bp, align="center"]
...
image::diagrams/history_bp_math.svg[id=history_bp_math, align="center"]
...
image::diagrams/history_data_compression.svg[id=history_data_compression, align="center"]
...
[.text-center]
.State in `HISTORY`
image::diagrams/history_ogtt.svg[id=history_ogtt, align="center"]
...
image::diagrams/history_single_sample.svg[id=history_single_sample, align="center", width=50%]
...
image::diagrams/history_bp_series_instances.svg[id=history_bp_series_instances, align="center", width=60%]
