...
h|*Inherit*
2+|`xref:{class_dv_encapsulated}[DV_ENCAPSULATED]`
...
h|*0..1*
|*alternate_text*: `xref:{class_string}[String]`
a|Text to display in lieu of multimedia display/replay.

h|*0..1*
|*uri*: `xref:{class_dv_uri}[DV_URI]`
...
h|*1..1*
|*is_external* (): `xref:{class_boolean}[Boolean]`
