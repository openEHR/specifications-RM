...
h|*Inherit*
2+|`xref:RM:data_types:basic_package.adoc#_data_value_class[DATA_VALUE]`, `link:/classes/Ordered[Ordered] `
...
h|*0..1*
|*other_reference_ranges*: `link:/classes/List[List] <xref:RM:data_types:quantity_package.adoc#_reference_range_class[REFERENCE_RANGE]<xref:RM:data_types:quantity_package.adoc#_dv_ordered_class[DV_ORDERED]>>`
