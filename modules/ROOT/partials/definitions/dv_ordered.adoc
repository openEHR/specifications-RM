...
h|*Inherit*
2+|`xref:{class_data_value}[DATA_VALUE]`, `link:/classes/Ordered[Ordered] `
...
h|*0..1*
|*other_reference_ranges*: `link:/classes/List[List] <xref:{class_reference_range}[REFERENCE_RANGE]<xref:{class_dv_ordered}[DV_ORDERED]>>`
