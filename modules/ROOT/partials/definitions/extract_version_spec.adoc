...
h|*1..1*
|*include_all_versions*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
...
h|*1..1*
|*include_revision_history*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
a|True if revision histories of the items in the Extract are included. If included, it is always the full revision history.

h|*1..1*
|*include_data*: `xref:BASE:foundation_types:primitive_types.adoc#_boolean_class[Boolean]`
