...
h|*1..1*
|*contribution*: `xref:{class_object_ref}[OBJECT_REF]`
a|Contribution in which this version was added.

h|*0..1*
|*signature*: `xref:{class_string}[String]`
a|OpenPGP digital signature or digest of content committed in this Version.

h|*1..1*
|*commit_audit*: `xref:{class_audit_details}[AUDIT_DETAILS]`
...
h|*1..1*
|*canonical_form* (): `xref:{class_string}[String]`
