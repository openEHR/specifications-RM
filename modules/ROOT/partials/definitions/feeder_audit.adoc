...
h|*0..1*
|*originating_system_item_ids*: `link:/classes/List[List] <xref:RM:data_types:basic_package.adoc#_dv_identifier_class[DV_IDENTIFIER]>`
a|Identifiers used for the item in the originating system, e.g. filler and placer ids.

h|*0..1*
|*feeder_system_item_ids*: `link:/classes/List[List] <xref:RM:data_types:basic_package.adoc#_dv_identifier_class[DV_IDENTIFIER]>`
