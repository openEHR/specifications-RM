...
h|*0..1*
|*originating_system_item_ids*: `link:/classes/List[List] <xref:{class_dv_identifier}[DV_IDENTIFIER]>`
a|Identifiers used for the item in the originating system, e.g. filler and placer ids.

h|*0..1*
|*feeder_system_item_ids*: `link:/classes/List[List] <xref:{class_dv_identifier}[DV_IDENTIFIER]>`
a|Identifiers used for the item in the feeder system, where the feeder system is distinct from the originating system.

h|*0..1*
|*original_content*: `xref:{class_dv_encapsulated}[DV_ENCAPSULATED]`
...
h|*1..1*
|*originating_system_audit*: `xref:{class_feeder_audit_details}[FEEDER_AUDIT_DETAILS]`
a|Any audit information for the information item from the originating system.

h|*0..1*
|*feeder_system_audit*: `xref:{class_feeder_audit_details}[FEEDER_AUDIT_DETAILS]`
