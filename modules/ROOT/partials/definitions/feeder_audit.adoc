...
h|*0..1*
|*originating_system_item_ids*: `xref:{class_list}[List]<xref:{class_dv_identifier}[DV_IDENTIFIER]>`
a|Identifiers used for the item in the originating system, e.g. filler and placer ids.

h|*0..1*
|*feeder_system_item_ids*: `xref:{class_list}[List]<xref:{class_dv_identifier}[DV_IDENTIFIER]>`
