...
h|*0..1*
|*chapters*: `xref:{class_list}[List]<xref:{class_extract_chapter}[EXTRACT_CHAPTER]>`
...
h|*1..1*
|*sequence_nr*: `xref:{class_integer}[Integer]`
...
h|*0..1*
|*participations*: `xref:{class_list}[List]<xref:{class_extract_participation}[EXTRACT_PARTICIPATION]>`
