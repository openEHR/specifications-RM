...
h|*1..1*
|*match*: `xref:{class_character}[Character]`
...
h|*0..1*
|*purpose*: `xref:{class_dv_coded_text}[DV_CODED_TEXT]`
a|Purpose of the mapping e.g. 'automated data mining', 'billing', 'interoperability'.

h|*1..1*
|*target*: `xref:{class_code_phrase}[CODE_PHRASE]`
...
h|*1..1*
|*equivalent* (): `xref:{class_boolean}[Boolean]`
