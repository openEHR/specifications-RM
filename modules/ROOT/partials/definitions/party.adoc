...
h|*1..1*
|*identities*: `link:/classes/List[List] <xref:RM:demographic:demographic_package.adoc#_party_identity_class[PARTY_IDENTITY]>`
a|Identities used by the party to identify itself, such as legal name, stage names, aliases, nicknames and so on.

h|*0..1*
|*contacts*: `link:/classes/List[List] <xref:RM:demographic:demographic_package.adoc#_contact_class[CONTACT]>`
...
h|*0..1*
|*reverse_relationships*: `link:/classes/List[List] <xref:RM:support:identification_package.adoc#_locatable_ref_class[LOCATABLE_REF]>`
...
h|*0..1*
|*relationships*: `link:/classes/List[List] <xref:RM:demographic:demographic_package.adoc#_party_relationship_class[PARTY_RELATIONSHIP]>`
