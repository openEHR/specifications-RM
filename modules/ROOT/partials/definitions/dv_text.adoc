...
h|*Inherit*
2+|`xref:{class_data_value}[DATA_VALUE]`
...
h|*0..1*
|*hyperlink*: `xref:{class_dv_uri}[DV_URI]`
...
h|*0..1*
|*formatting*: `xref:{class_string}[String]`
...
h|*0..1*
|*mappings*: `xref:{class_list}[List]<xref:{class_term_mapping}[TERM_MAPPING]>`
