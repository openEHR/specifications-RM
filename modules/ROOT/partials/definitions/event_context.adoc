...
h|*1..1*
|*start_time*: `xref:{class_dv_date_time}[DV_DATE_TIME]`
...
h|*0..1*
|*participations*: `xref:{class_list}[List]<xref:{class_participation}[PARTICIPATION]>`
