...
h|*0..1*
|*rows*: `xref:{class_cluster}[CLUSTER]`
...
h|*0..1*
|*row_names* (): `link:/classes/List[List] <xref:{class_dv_text}[DV_TEXT]>`
a|

h|*0..1*
|*column_names* (): `link:/classes/List[List] <xref:{class_dv_text}[DV_TEXT]>`
a|
