...
h|*1..1*
|*territory*: `xref:{class_code_phrase}[CODE_PHRASE]`
...
h|*1..1*
|*category*: `xref:{class_dv_coded_text}[DV_CODED_TEXT]`
...
h|*0..1*
|*content*: `xref:{class_list}[List]<xref:{class_content_item}[CONTENT_ITEM]>`
...
h|*1..1*
|*is_persistent* (): `xref:{class_boolean}[Boolean]`
