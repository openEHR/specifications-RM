...
h|*Inherit*
2+|`xref:RM:common:generic_package.adoc#_party_identified_class[PARTY_IDENTIFIED]`
...
h|*1..1*
|*relationship*: `xref:RM:data_types:text_package.adoc#_dv_coded_text_class[DV_CODED_TEXT]`
