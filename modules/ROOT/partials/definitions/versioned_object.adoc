...
h|*1..1*
|*all_version_ids* (): `link:/classes/List[List] <xref:RM:support:identification_package.adoc#_object_version_id_class[OBJECT_VERSION_ID]>`
a|Return a list of ids of all versions in this object.

h|*1..1*
|*all_versions* (): `link:/classes/List[List] <xref:RM:common:change_control_package.adoc#_version_class[VERSION]<T>>`
