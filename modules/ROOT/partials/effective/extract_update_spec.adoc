...
|*persist_in_server*: `link:/classes/Boolean[Boolean] ` [1..1]
...
|*trigger_events*: `link:/classes/List[List] <xref:RM:data_types:text_package.adoc#_dv_coded_text_class[DV_CODED_TEXT]>` [0..1]
