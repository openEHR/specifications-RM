...
|*territory*: `xref:{class_code_phrase}[CODE_PHRASE]` [1..1]
...
|*category*: `xref:{class_dv_coded_text}[DV_CODED_TEXT]` [1..1]
...
|*content*: `xref:{class_list}[List]<xref:{class_content_item}[CONTENT_ITEM]>` [0..1]
