...
2+|Inherits: xref:{class_pathable}[PATHABLE], xref:{class_locatable}[LOCATABLE], xref:{class_extract_item}[EXTRACT_ITEM], xref:{class_extract_content_item}[EXTRACT_CONTENT_ITEM]
