...
|*items*: `link:/classes/List[List] <xref:RM:data_structures:item_structure_package.adoc#_element_class[ELEMENT]>` [0..1]
...
|*item_count* (): `link:/classes/Integer[Integer] ` [1..1]
a|Count of all items.

|*names* (): `link:/classes/List[List] <xref:RM:data_types:text_package.adoc#_dv_text_class[DV_TEXT]>` [0..1]
