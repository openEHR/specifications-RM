...
|*other_input_version_uids*: `link:/classes/List[List] <xref:{class_object_version_id}[OBJECT_VERSION_ID]>` [0..1]
...
|*attestations*: `link:/classes/List[List] <xref:{class_attestation}[ATTESTATION]>` [0..1]
