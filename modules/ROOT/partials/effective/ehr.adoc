...
|*contributions*: `link:/classes/List[List] <xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]>` [0..1]
...
|*compositions*: `link:/classes/List[List] <xref:RM:support:identification_package.adoc#_object_ref_class[OBJECT_REF]>` [0..1]
