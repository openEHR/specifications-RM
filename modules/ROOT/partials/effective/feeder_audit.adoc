...
|*originating_system_item_ids*: `link:/classes/List[List] <xref:{class_dv_identifier}[DV_IDENTIFIER]>` [0..1]
a|Identifiers used for the item in the originating system, e.g. filler and placer ids.

|*feeder_system_item_ids*: `link:/classes/List[List] <xref:{class_dv_identifier}[DV_IDENTIFIER]>` [0..1]
