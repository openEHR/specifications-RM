...
|*originating_system_item_ids*: `link:/classes/List[List] <xref:RM:data_types:basic_package.adoc#_dv_identifier_class[DV_IDENTIFIER]>` [0..1]
a|Identifiers used for the item in the originating system, e.g. filler and placer ids.

|*feeder_system_item_ids*: `link:/classes/List[List] <xref:RM:data_types:basic_package.adoc#_dv_identifier_class[DV_IDENTIFIER]>` [0..1]
