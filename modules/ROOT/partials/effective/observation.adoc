...
|*data*: `xref:{class_history}[HISTORY]<xref:{class_item_structure}[ITEM_STRUCTURE]>` [1..1]
a|The data of this observation, in the form of a history of values which may be of any complexity.

|*state*: `xref:{class_history}[HISTORY]<xref:{class_item_structure}[ITEM_STRUCTURE]>` [0..1]
