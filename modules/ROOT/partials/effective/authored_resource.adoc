...
|*is_controlled*: `link:/classes/Boolean[Boolean] ` [0..1]
a|True if this resource is under any kind of change control (even file copying), in which case revision history is created.

|*translations*: `link:/classes/List[List] <xref:RM:common:resource_package.adoc#_translation_details_class[TRANSLATION_DETAILS]>` [0..1]
...
|*languages_available* (): `link:/classes/List[List] <link:/classes/String[String] >` [1..1]
