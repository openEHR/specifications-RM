...
|*alternate_text*: `xref:{class_string}[String]` [0..1]
...
|*data*: `xref:{class_array}[Array]<xref:{class_octet}[Octet]>` [0..1]
...
|*integrity_check*: `xref:{class_array}[Array]<xref:{class_octet}[Octet]>` [0..1]
...
|*size*: `xref:{class_integer}[Integer]` [1..1]
...
|*is_external* (): `xref:{class_boolean}[Boolean]` [1..1]
