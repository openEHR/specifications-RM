...
|*row_count* (): `link:/classes/Integer[Integer] ` [1..1]
a|

|*column_count* (): `link:/classes/Integer[Integer] ` [1..1]
a|

|*row_names* (): `link:/classes/List[List] <xref:RM:data_types:text_package.adoc#_dv_text_class[DV_TEXT]>` [0..1]
a|

|*column_names* (): `link:/classes/List[List] <xref:RM:data_types:text_package.adoc#_dv_text_class[DV_TEXT]>` [0..1]
a|
