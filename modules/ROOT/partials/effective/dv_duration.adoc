...
|*less_than* __alias__ "<" ( +
other: `xref:{class_dv_duration}[DV_DURATION][1]` +
...
|*negative* __alias__ "-" (): `xref:{class_dv_duration}[DV_DURATION]` [1..1]
...
a|Returns False. +
_Inherited from xref:{class_iso8601_duration}[Iso8601_duration]_
