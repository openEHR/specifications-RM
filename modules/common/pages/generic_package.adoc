...
image::ROOT:uml/RM-common.generic.svg[id=generic_package, align="center"]
...
include::ROOT:partial$classes/party_proxy.adoc[]

include::ROOT:partial$classes/party_self.adoc[]

include::ROOT:partial$classes/party_identified.adoc[]

include::ROOT:partial$classes/party_related.adoc[]

include::ROOT:partial$classes/participation.adoc[]

include::ROOT:partial$classes/audit_details.adoc[]

include::ROOT:partial$classes/attestation.adoc[]

include::ROOT:partial$classes/revision_history.adoc[]

include::ROOT:partial$classes/revision_history_item.adoc[]
