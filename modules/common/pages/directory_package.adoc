...
image::ROOT:uml/RM-common.directory.svg[id=directory_package, align="center"]
...
include::ROOT:partial$classes/versioned_folder.adoc[]

include::ROOT:partial$classes/folder.adoc[]
