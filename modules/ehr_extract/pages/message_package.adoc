...
[.text-center]
.rm.message Package
image::ROOT:uml/RM-ehr_extract.message.svg[id=rm__extract_message, align="center"]
...
include::ROOT:partial$classes/addressed_message.adoc[]

include::ROOT:partial$classes/message.adoc[]
