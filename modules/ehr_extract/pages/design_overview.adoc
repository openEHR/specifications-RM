...
* _Generic Extract_: an Extract type designed for use with non-openEHR systems communicating to openEHR systems, and users of the ISO 13606 Extract specification. The Generic Extract assumes the absolute minimum about what is in a system, while remaining withing the openEHR type system;
...
image::ROOT:uml/RM-ehr_extract-packages.svg[id=rm_ehr_extract_packages, align="center"]
