...
image::ROOT:uml/RM-ehr_extract.common.svg[id=rm_ehr_extract_common, align="center"]
...
include::ROOT:partial$classes/extract_request.adoc[]

include::ROOT:partial$classes/extract_action_request.adoc[]

include::ROOT:partial$classes/extract_spec.adoc[]

include::ROOT:partial$classes/extract_manifest.adoc[]

include::ROOT:partial$classes/extract_entity_manifest.adoc[]

include::ROOT:partial$classes/extract_version_spec.adoc[]

include::ROOT:partial$classes/extract_update_spec.adoc[]

include::ROOT:partial$classes/extract.adoc[]

include::ROOT:partial$classes/extract_chapter.adoc[]

include::ROOT:partial$classes/extract_entity_chapter.adoc[]

include::ROOT:partial$classes/extract_item.adoc[]

include::ROOT:partial$classes/extract_folder.adoc[]

include::ROOT:partial$classes/extract_content_item.adoc[]

include::ROOT:partial$classes/extract_participation.adoc[]
