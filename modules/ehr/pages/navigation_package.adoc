...
image::diagrams/ehr_with_sections.svg[id=ehr_with_sections, align="center", width=50%]
...
image::diagrams/Composition_with_sections.svg[id=SOAP_section_structure, align="center"]
