...
The `navigation` Package defines a hierachical heading structure, in which all individual headings are considered to belong to a "tree of headings". Each heading is an instance of the class `SECTION`, visible in the lower left side of the figure <<rm_composition>>.
...
image::diagrams/ehr_with_sections.png[id=ehr_with_sections, align="center", width=70%]
...
include::ROOT:partial$classes/section.adoc[]
...
image::diagrams/SOAP_section_structure.png[id=SOAP_section_structure, align="center", width=80%]
