...
image::ROOT:uml/RM-support.terminology.svg[id=base_terminology, align="center"]
...
include::ROOT:partial$classes/terminology_service.adoc[]

include::ROOT:partial$classes/terminology_access.adoc[]

include::ROOT:partial$classes/code_set_access.adoc[]

include::ROOT:partial$classes/openehr_terminology_group_identifiers.adoc[]

include::ROOT:partial$classes/openehr_code_set_identifiers.adoc[]
