...
image::ROOT:uml/BASE-base_types.assumed_types.svg[id=base_assumed_types, align="center"]
...
image::ROOT:uml/BASE-base_types.structure.svg[id=base_structure_types, align="center"]
...
image::ROOT:uml/BASE-base_types.time.svg[id=base_time_types, align="center"]
