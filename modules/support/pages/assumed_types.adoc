...
image::{uml_diagrams_uri}/BASE-base_types.assumed_types.svg[id=base_assumed_types, align="center"]
...
image::{uml_diagrams_uri}/BASE-base_types.structure.svg[id=base_structure_types, align="center"]
...
image::{uml_diagrams_uri}/BASE-base_types.time.svg[id=base_time_types, align="center"]
