...
image::ROOT:uml/RM-data_types.text.svg[id=rm_data_types_text, align="center"]
...
include::ROOT:partial$classes/dv_text.adoc[]

include::ROOT:partial$classes/term_mapping.adoc[]

include::ROOT:partial$classes/code_phrase.adoc[]

include::ROOT:partial$classes/dv_coded_text.adoc[]

include::ROOT:partial$classes/dv_paragraph.adoc[]
