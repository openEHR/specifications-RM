...
ad hoc way. (See cite:[Meyer_OOSC2] p366, cite:[Booch1994] p43, cite:[Kilov1994] p29 for detailed explanations of the invariant concept).
...
image::diagrams/HL7_null_value.png[id=HL7_null_value, align="center", width=65%]
