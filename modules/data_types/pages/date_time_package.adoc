...
image::ROOT:uml/RM-data_types.quantity.date_time.svg[id=rm_data_types_quantity_date_time, align="center"]
...
String, in the form of an {iso_8601_official}[ISO 8601:2019] string. ISO 8601 is convenient for this purpose, as it is a simple
...
include::ROOT:partial$classes/dv_temporal.adoc[]

include::ROOT:partial$classes/dv_date.adoc[]

include::ROOT:partial$classes/dv_time.adoc[]

include::ROOT:partial$classes/dv_date_time.adoc[]

include::ROOT:partial$classes/dv_duration.adoc[]
