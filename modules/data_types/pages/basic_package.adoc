...
image::ROOT:uml/RM-data_types.basic.svg[id=rm_data_types_basic, align="center"]
...
image::diagrams/state_machine.png[id=state_machine_med_order, align="center", width=80%]
...
include::ROOT:partial$classes/data_value.adoc[]

include::ROOT:partial$classes/dv_boolean.adoc[]

include::ROOT:partial$classes/dv_state.adoc[]

include::ROOT:partial$classes/dv_identifier.adoc[]
