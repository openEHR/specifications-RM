...
image::ROOT:uml/RM-data_types.uri.svg[id=rm_data_types_uri, align="center"]
...
include::ROOT:partial$classes/dv_uri.adoc[]

include::ROOT:partial$classes/dv_ehr_uri.adoc[]
