...
image::ROOT:uml/RM-data_types.encapsulated.svg[id=rm_data_types_encapsulated, align="center"]
...
include::ROOT:partial$classes/dv_encapsulated.adoc[]

include::ROOT:partial$classes/dv_multimedia.adoc[]

include::ROOT:partial$classes/dv_parsable.adoc[]
