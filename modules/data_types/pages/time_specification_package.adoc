...
image::ROOT:uml/RM-data_types.time_specification.svg[id=rm_data_types_time_specification, align="center"]
...
include::ROOT:partial$classes/dv_time_specification.adoc[]

include::ROOT:partial$classes/dv_periodic_time_specification.adoc[]

include::ROOT:partial$classes/dv_general_time_specification.adoc[]
